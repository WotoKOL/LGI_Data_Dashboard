        ...
        <CardContent className="pt-4">
          ...
          {rankingData && rankingData.rows.length > 0 ? <>
            <div className="overflow-x-auto"><Table>
              <TableHeader><TableRow><TableHead className="w-20">排名</TableHead><TableHead>品牌方 ID</TableHead><TableHead>品牌方平台</TableHead><TableHead>手机号</TableHead><TableHead className="text-right">商单总数量</TableHead><TableHead className="text-right">待审核总数量</TableHead></TableRow></TableHeader>
